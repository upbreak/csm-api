...
func (r *Repository) GetWorkerTotalCount(ctx context.Context, db Queryer, searchTime string) (int, error) {
	var count int
	...
	if err := db.GetContext(ctx, &count, query, searchTime); err != nil {
