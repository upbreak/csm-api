...
// 프로젝트 관리
func (p *ServiceProject) GetProjectNmUnoList(ctx context.Context, uno int64) (*entity.ProjectInfos, error) {
	...
	sqlList, err := p.Store.GetProjectNmUnoList(ctx, p.DB, unoSql)
